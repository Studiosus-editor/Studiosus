<script>
  import { nameStore, textareaStore } from "../scripts/store.js";
...
<div id="Assistant-container">
  <div id="Assistant-controller">
    ...
    <button id="new-chat-btn" on:click={handleNewChatBtn}>
      <img src={newChat} alt="New Chat" width="20px" height="20px" />
    </button>
  </div>
  <div id="Inform-container" style="display: none;">
    Login in to use the Studiosus assistant.
    <a href="/login" style="text-decoration: none;"
      ><button id="login-button">Sign in to Studiosus</button></a
    >
  </div>
